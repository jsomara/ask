...
GroupDropdown.prototype.enableAddGroups = function(){
    ...
    var group_link_li = this.makeElement('li');
    link_group_a = this.makeElement('a');
    link_group_a.attr('href', '/groups/');
    link_group_a.attr('class', 'group-name');
    link_group_a.text(gettext("groups"));
    group_link_li.append(link_group_a);
    this._element.append(group_link_li);
