...
DATABASES = {
    'default': {
        ...
        'USER': 'adminqaeagnp',                      # Not used with sqlite3.
        'PASSWORD': 'ThgVt55usnlK',                  # Not used with sqlite3.
...
ASKBOT_USE_STACKEXCHANGE_URLS = True #mimic url scheme of stackexchange
